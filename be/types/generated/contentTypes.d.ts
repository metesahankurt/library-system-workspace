...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    backCover: Schema.Attribute.Media<'images'>;
    barcodeImage: Schema.Attribute.Text;
    barcodeNumber: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    bookCode: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    ...
    frontCover: Schema.Attribute.Media<'images'>;
    ...
    >;
    status: Schema.Attribute.Enumeration<['active', 'archived', 'damaged']> &
      Schema.Attribute.Required &
...
export interface ApiLoanLoan extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Book loans (checkouts)';
    displayName: 'Loan';
    pluralName: 'loans';
    singularName: 'loan';
  };
  ...
  attributes: {
    ...
    loanedAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiReservationReservation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expiresAt: Schema.Attribute.DateTime;
    immediate: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
